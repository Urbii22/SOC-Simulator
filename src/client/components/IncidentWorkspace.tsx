  ...
  return (
    <main className="workspace">
      <header className="incident-header">
        <div className="breadcrumb"><span>Expediente de investigación</span><ChevronRight size={13} /><span>{scenario.id.toUpperCase()}</span></div>
